process quality4 {
   ...
   output:
      ...
      val "${params.output}/dengue4/${x}", emit: outputpath1
   ...
   cp ${params.input}/dengue4/${x}_*.fastq.gz ${params.output}/dengue4/${x}
   
   #Run fastqc on original reads
   singularity exec --cleanenv docker://staphb/fastqc:0.11.9 fastqc ${params.output}/dengue4/${x}/${x}_1.fastq.gz ${params.output}/dengue4/${x}/${x}_2.fastq.gz
   ...
   singularity exec -B ${params.output}/dengue4/${x}:/data docker://ncbi/sra-human-scrubber:1.1.2021-05-05 /opt/scrubber/scripts/scrub.sh -r -i /data/${x}_1.fastq -o /data/${x}_1_humanclean.fastq
   singularity exec -B ${params.output}/dengue4/${x}:/data docker://ncbi/sra-human-scrubber:1.1.2021-05-05 /opt/scrubber/scripts/scrub.sh -r -i /data/${x}_2.fastq -o /data/${x}_2_humanclean.fastq
   ...
   singularity exec --cleanenv docker://staphb/trimmomatic:0.39 trimmomatic PE -phred33 -trimlog ${params.output}/dengue4/${x}/${x}.log ${params.output}/dengue4/${x}/${x}_1_humanclean.fastq.gz ${params.output}/dengue4/${x}/${x}_2_humanclean.fastq.gz ${params.output}/dengue4/${x}/${x}_trim_1.fastq.gz ${params.output}/dengue4/${x}/${x}_unpaired_trim_1.fastq.gz ${params.output}/dengue4/${x}/${x}_trim_2.fastq.gz ${params.output}/dengue4/${x}/${x}_unpaired_trim_2.fastq.gz SLIDINGWINDOW:4:30 MINLEN:75 TRAILING:20 > ${params.output}/dengue4/${x}/${x}_trimstats.txt
   ...
   singularity exec --cleanenv docker://staphb/fastqc:0.11.9 fastqc ${params.output}/dengue4/${x}/${x}_1.fq.gz ${params.output}/dengue4/${x}/${x}_2.fq.gz
   ...
   #Run multiqc
   singularity exec --cleanenv docker://staphb/multiqc:1.8 multiqc ${params.output}/dengue4/${x}/${x}_*_fastqc.zip -o ${params.output}/dengue4/${x}
