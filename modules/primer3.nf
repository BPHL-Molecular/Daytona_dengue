process primer3 {
    ...
    singularity exec docker://staphb/ivar ivar trim -i ${mypath}/alignment/\${samplename}.sorted.bam  -b ${params.primer}/DENV3.primer.bed -p ${mypath}/alignment/\${samplename}.primertrim -e
